...
# -*- coding: utf-8 -*-
"""
Created on Tue May 18 02:09:24 2021
...
outpath = r'/home/cwlab08/Desktop/revision_figures/dark_individual/'
...
nonDF = darkDF.loc[darkDF.rem<12.5]
subDF = darkDF.loc[darkDF.rem>=12.5]
...
remDF = rp.standard_recToDF(ppath, recordings, 8, True) #isDark = True
