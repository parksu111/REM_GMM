...
outpath = r'/home/cwlab08/Desktop/nrev_figs/ma10/'
...
#significant locs
eeg1sws_sig3f1 = np.arange(0.3333, 5.3333, 0.0001)
...
plt.scatter(eeg1sws_sig3f3, 1100,s=1,color='k')
sns.despine()
plt.legend()
...
eeg2sws_sig3f2 = np.arange(8, 15, 0.0001)
...
#For Wake count up to 8
subwcDF = wakeDF.loc[wakeDF.wcount<9]
swsbywcount2 = [wcount0.sws,wcount1.sws,wcount2.sws,wcount3.sws,wcount4.sws,wcount5.sws,wcount6.sws,wcount7.sws,wcount8.sws]
xpos3 = [0,1,2,3,4,5,6,7,8]
